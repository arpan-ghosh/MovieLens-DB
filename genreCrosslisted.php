    ...
    <!-- <video loop muted autoplay poster="assets/video.mp4" class="fullscreen-bg__video">
        ...
        <!-- Header -->
                    ...
                    <header id="header">
                        ...
                        <p> List of All Movies Crosslisted with Both Searched Genres &nbsp;&nbsp;
            </p>
        ...
        <?php
            include 'open.php';
            $movie = $_POST["movie"]; 
            $movie2 = $_POST["movie2"];                                            // Get 

            $mysqli->multi_query("CALL Crosslisted('".$movie."','".$movie2."');");       //Execute the query with the input. (AllRawScores)
