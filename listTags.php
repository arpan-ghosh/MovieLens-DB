    ...
    <!-- <video loop muted autoplay poster="assets/video.mp4" class="fullscreen-bg__video">
        ...
        <!-- Header -->
                    ...
                    <header id="header">
                        ...
                        <p> These Are All The Tags on a Movie that Contains The Word You Searched &nbsp;&nbsp;
            </p>
        ...
        <?php
            ...
            $mysqli->multi_query("CALL ListTags('".$movie."');");        //Execute the query with the input. (AllRawScores)
