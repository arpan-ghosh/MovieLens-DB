...
<html>
    ...
    <!-- <video loop muted autoplay poster="assets/video.mp4" class="fullscreen-bg__video">
        ...
        <!-- Header -->
                    ...
                    <header id="header">
                        <h1>ListMovieswithGenres Procedure</h1>
                        ...
                        <p> List of All Movies and their Genres in our Database &nbsp;&nbsp;
            </p>
        ...
        <?php
            ...
            $mysqli->multi_query("CALL ListMovieswithGenres();");        //Execute the query with the input. (AllRawScores)
