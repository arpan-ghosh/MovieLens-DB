...
<html>
    ...
    <!-- <video loop muted autoplay poster="assets/video.mp4" class="fullscreen-bg__video">
        ...
        <!-- Header -->
                    ...
                    <header id="header">
                        <h1>The Most Popular Tag</h1>
                        <A HREF = "http://www.arpanghosh.com/cs315">Click to Go Back to Home</A> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <A HREF = "http://www.arpanghosh.com/cs315/stored.html">Click to Go Back to Stored Procedures</A>
                        <p> The Most Popular User Submitted Tag for Your Movie, and the # of Users who Submitted It &nbsp;&nbsp;
            </p>
        ...
        <?php
            ...
            $mysqli->multi_query("CALL popularTag('".$movie."');");        //Execute the query with the input. (AllRawScores)
