...
<html>
    ...
    <!-- <video loop muted autoplay poster="assets/video.mp4" class="fullscreen-bg__video">
        ...
        <!-- Header -->
                    ...
                    <header id="header">
                        <h1>ListRankByGenre Procedure</h1>
                        ...
                        <p> List of All Movies And User Defined Tags in our Database &nbsp;&nbsp;
            </p>
        ...
        <?php
            ...
            $mysqli->multi_query("CALL ListMovieswithTag();");        //Execute the query with the input. (AllRawScores)
