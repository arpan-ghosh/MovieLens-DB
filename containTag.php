...
<html>
    ...
    <!-- <video loop muted autoplay poster="assets/video.mp4" class="fullscreen-bg__video">
        ...
        <!-- Header -->
                    ...
                    <header id="header">
                        <h1>Movies with Searched Tag</h1>
                        ...
                        <p> Movies with Your Searched Tag &nbsp;&nbsp;
            </p>
        ...
        <?php
            ...
            $mysqli->multi_query("CALL MoviewithTags('".$movie."');");        //Execute the query with the input. (AllRawScores)
