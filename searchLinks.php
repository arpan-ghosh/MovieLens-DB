...
<html>
    ...
    <!-- <video loop muted autoplay poster="assets/video.mp4" class="fullscreen-bg__video">
        ...
        <!-- Header -->
                    ...
                    <header id="header">
                        <h1>User Tags of Movie to Public DBs</h1>
                        ...
                        <p> List of Public User Attributed DB Tags for Your Searched Movie &nbsp;&nbsp;
            </p>
        ...
        <?php
            ...
            $mysqli->multi_query("CALL ListLinks('".$movie."');");        //Execute the query with the input. (AllRawScores)
